      ...
      <main>
          ...
          <div className="about-card">
            <div className="card2">
              <p id="style-5">
                ...
                <br /><br /> */}
                <br /><br />
                &#x1F680; I’m a Toronto-based tech enthusiast with a passion for app development, teaching, and tackling new coding challenges. I love sharing knowledge, continuously learning, and exploring the world of technology. When I’m not coding, you’ll find me staying active with sports, capturing moments with my camera, or uncovering unique spots around the city. I’m always looking for new ways to make a positive impact and enjoy life’s adventures.
        ...
        <section className="portfolio">
          ...
          <div className="projects-container">
            ...
            <div className="card">
              <img src="/images/SparkSensePic.png" alt="SparkSense"/>

              <div className="card__content">

                <p className="card__title">
                  <span><a target="_blank" rel="noreferrer" href="https://github.com/bradleyyang/SparkSense">SparkSense</a> </span>
                  <svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512">
                    <path fill="#ffffff"
                      d="M352 0c-12.9 0-24.6 7.8-29.6 19.8s-2.2 25.7 6.9 34.9L370.7 96 201.4 265.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L416 141.3l41.4 41.4c9.2 9.2 22.9 11.9 34.9 6.9s19.8-16.6 19.8-29.6V32c0-17.7-14.3-32-32-32H352zM80 32C35.8 32 0 67.8 0 112V432c0 44.2 35.8 80 80 80H400c44.2 0 80-35.8 80-80V320c0-17.7-14.3-32-32-32s-32 14.3-32 32V432c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V112c0-8.8 7.2-16 16-16H192c17.7 0 32-14.3 32-32s-14.3-32-32-32H80z" />
                ...
                <p className="card__description">SparkSense is an early wildfire detection tool that informs and alerts first responders to take action with ease. It expedites the process of responding to emergency wildfires. The inspiration came from the anxiety from climate change disasters that people experience in stressful times.</p>
              </div>
            </div>
